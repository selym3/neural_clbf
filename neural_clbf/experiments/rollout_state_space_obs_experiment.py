...
class RolloutStateSpaceObsExperiment(Experiment):
    ...
    def __init__(
        ...
        """
        super(RolloutStateSpaceObsExperiment, self).__init__(name)
    ...
    def run(self, controller_under_test: "Controller") -> pd.DataFrame:
        ...
        for tstep in prog_bar_range:
            ...
            for i in range(n_sims):
                ...
                x_current[i, self.state_length:] = controller_under_test.dynamics_model._f(x_current[i, :].unsqueeze(0), random_scenarios[i]).squeeze()[self.state_length:]
