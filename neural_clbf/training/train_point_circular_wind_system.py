...
from neural_clbf.systems import PointInCirWind
...
def main(args):
    ...
    nominal_params = {}
    dynamics_model = PointInCirWind(nominal_params, dt=simulation_dt, controller_dt=controller_period)
    ...
    V_contour_experiment = CLFContourExperiment(
        ...
        n_grid=25,
        x_axis_index=PointInCirWind.X,
        y_axis_index=PointInCirWind.Y,
        x_axis_label="$x$",
        y_axis_label="$y$",
    ...
    tb_logger = pl_loggers.TensorBoardLogger(
        "logs/point_circular_wind_system/", name=f"commit_{current_git_hash}"
    )
